...
trainOpts.expDir = 'data/chinesechar-experiment' ;
...
save('data/chinesechar-experiment/chinesecharscnn.mat', '-struct', 'net') ;
...
net = load('data/chinesechar-experiment/chinesecharscnn.mat') ;
%net = load('data/chinesechar-experiment/chinesecharscnn-jit.mat') ;
 
% Load the sentence
im1 = im2single(rgb2gray(imresize((imread('attachments/2.png')),[32,32]))) ;
im = 256 * (im1 - net.imageMean) ;
...
% trainOpts.continue = true ;
% trainOpts.learningRate = 0.001 ;
% trainOpts.expDir = 'data/chinesechars-jit-experiment' ;
%  
% % Initlialize a new network
% net = initializeCharacterCNN_1() ;
%  
% % Call training function in MatConvNet
...
% net.layers(end) = [] ;
% net.imageMean = imageMean ;
% save('data/chinesechar-experiment/chinesecharscnn-jit.mat', '-struct', 'net') ;
%  
