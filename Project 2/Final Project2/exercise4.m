...
trainOpts.expDir = 'data/chardatabase-experiment' ;
...
save('data/chardatabase-experiment/chardatabasecnn.mat', '-struct', 'net') ;
...
net = load('data/chardatabase-experiment/chardatabasecnn.mat') ;
%net = load('data/chinesechar-experiment/chinesecharscnn-jit.mat') ;
 


% Load the font image
im1 = im2single(rgb2gray(imresize((imread('attachments/7.png')),[32,32]))) ;
im = (im1 - net.imageMean) ;
% Apply the CNN to the larger imag3
res = vl_simplenn(net, im) ;

% Visualize the results
figure(3) ;
title('Without Jittering');
clf ;
...
trainOpts.continue = true ;
trainOpts.learningRate = 0.001 ;
trainOpts.expDir = 'data/chardatabase-jit-experiment' ;
...
% Visualize the results from 1.png to 9.png
